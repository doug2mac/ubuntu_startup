...
values."
  (setq-default
   ...
   '(
     ...
     ranger
     ;; ipython-notebook
     ;; Spell checking, added 2018-08-24
     ;; spell-checking
     ;; pdf-tools added on 2018-09-01
     pdf-tools
     )
...
values."
  ...
  (setq-default
   ...
   ;; MY VARS ;;
   dotspacemacs-global-visual-line-mode t
   ))
...
;`dotspacemacs/user-config' first."
   ...
   ;; Make it so visual line mode, and word wrap is enabled in org (added on 7/10)
   (defun org-line-wrap ()
